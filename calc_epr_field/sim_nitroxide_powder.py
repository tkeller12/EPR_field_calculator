...
def simulate_nitroxide_spectrum(frequency):
    # EPR parameters
...
if __name__ == "__main__":
    B, spectrum = simulate_nitroxide_spectrum(34.0e9)
#    B, spectrum = simulate_nitroxide_spectrum(9.5e9)
    # Get field at maximum
    B_max = B[np.argmax(spectrum)]

    # Plot
    plt.figure(figsize=(8, 4))
    plt.plot(B * 1e3, spectrum, label="Frozen Nitroxide Spectrum")
